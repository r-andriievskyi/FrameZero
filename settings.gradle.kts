...
include(":shared:features:force-update")
...
include(":shared:repositories:tasks:api")
include(":shared:repositories:tasks:impl")
include(":shared:repositories:chat:api")
include(":shared:repositories:chat:impl")
include(":shared:repositories:device-token")
include(":shared:repositories:force-update:api")
include(":shared:repositories:force-update:impl")
