...
declare -a PRODUCTIONS=(
  ...
  "Corner Store Blues|COMEDY|POST_PRODUCTION|A family-owned convenience store becomes the unlikely hub of neighbourhood drama.|$(date_add -200)|$(date_add -20)|18000000"
  "The Quiet Epidemic|DOCUMENTARY|DISTRIBUTION|An investigative look at the rise of chronic loneliness in modern cities.|$(date_add -300)|$(date_add -35)|5000000"
