 ...
 * two goldens.
 *
 * Record with `:composeApp:features:production-details:recordRoborazziDebug`, check drift with
 * `:composeApp:features:production-details:verifyRoborazziDebug`. Robolectric native graphics + SDK
