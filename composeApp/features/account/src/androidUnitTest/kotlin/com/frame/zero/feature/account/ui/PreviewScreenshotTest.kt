 ...
 *
 * Record with `:composeApp:features:account:recordRoborazziDebug`, check drift with
 * `:composeApp:features:account:verifyRoborazziDebug`. Robolectric native graphics + SDK level come
