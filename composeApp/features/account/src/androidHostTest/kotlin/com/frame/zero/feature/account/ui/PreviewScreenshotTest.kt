...
/**
 * Golden-image coverage for every `@LightDarkPreview` (and any other `@Preview`) in the account
 ...
 *
 * Record with `:composeApp:features:account:recordRoborazziAndroidHostTest`, check drift with
 * `:composeApp:features:account:verifyRoborazziAndroidHostTest`. Robolectric native graphics + SDK level come
 * from `androidHostTest/resources/robolectric.properties`.
 */
  ...
  companion object {
    ...
    fun previews(): List<ComposablePreview<AndroidPreviewInfo>> =
      AndroidComposablePreviewScanner()
        .scanPackageTrees("com.frame.zero.feature.account.ui")
