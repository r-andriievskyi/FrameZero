...
/**
 * Golden-image coverage for every `@LightDarkPreview` (and any other `@Preview`) in the task-create
 ...
 *
 * Record with `:composeApp:features:task-create:recordRoborazziAndroidHostTest`, check drift with
 * `:composeApp:features:task-create:verifyRoborazziAndroidHostTest`. Robolectric native graphics + SDK level
  ...
  companion object {
    ...
    fun previews(): List<ComposablePreview<AndroidPreviewInfo>> =
      AndroidComposablePreviewScanner()
        .scanPackageTrees("com.frame.zero.feature.task.create.ui")
