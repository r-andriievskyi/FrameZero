 ...
 *
 * Record with `:composeApp:features:task-details:recordRoborazziDebug`, check drift with
 * `:composeApp:features:task-details:verifyRoborazziDebug`. Robolectric native graphics + SDK level
