 ...
 *
 * Record with `:composeApp:shared:design_system:recordRoborazziDebug`, check drift with
 * `:composeApp:shared:design_system:verifyRoborazziDebug`. Robolectric native graphics + SDK level
